    ...
    {!! Form::open(['route' => 'customer.address.create', 'class' => 'ps-form--account-setting', 'method' => 'POST']) !!}
        ...
        <div class="ps-form__content">
                ...
                <div class="form-group @if ($errors->has('country')) has-error @endif" style="display:none">
                    ...
                    <select name="country" class="form-control" id="country" change="PE">
                        @foreach(['' => __('Select country...')] + EcommerceHelper::getAvailableCountries() as $countryCode => $countryName)
                            <option value="{{ $countryCode }}" @if($countryCode=='PE' ) selected @endif @if (old('country') == $countryCode) selected @endif>{{ $countryName }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-group @if ($errors->has('state')) has-error @endif" style="display:none">
                ...
                <input id="state" type="text" class="form-control" name="state" value="{{ old('state','NO APLICA') }}">
            ...
            <div class="form-group @if ($errors->has('city')) has-error @endif" style="display:none">
                ...
                <input id="city" type="text" class="form-control" name="city" value="{{ old('city','NO APLICA') }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select  style="width: 790px" class="form-control-lg select_2 required checkout-input" id="address_ubigeo" name="ubigeo" required></select>
